      ...
      <div className="flex items-center py-4 pl-4 pr-10">
        ...
        <div className="w-full flex justify-between ">
          <div className="flex md:order-2 gap-3 ">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                type="text"
                id="search-navbar"
                className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray rounded-3xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search..."
              />
            </div>
            ...
            >
              ...
              <div className="relative w-10 h-10">
                <img
                  ...
                  src="https://i.pinimg.com/736x/6a/9c/3f/6a9c3fa8765bbab737082071e601357e.jpg"
                  fill
                />
              </div>
            </div>
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-3xl bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white  dark:border-gray-700">
              <li>
                <Link
                  href="/todo-list"
